...
% \section{Identifying key themes and efficient storage for qualitative analysis\\\vspace{12pt} Ellen Kirkpatrick}

% \includepdf[pages=-]{presentations/ellen.pdf}


\makeslide{Identifying key themes and efficient storage for qualitative analysis}{Ellen Kirkpatrick}{ellen.pdf}
\makeslide{The Hieroglyphics Initiative Workshop: Sharing Files Made Easy}{Bree Kelly}{PICO_42849705.pdf}
